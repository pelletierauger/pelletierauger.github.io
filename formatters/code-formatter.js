...
module.exports = function(htmlContent, fileName) {
    ...
    if (htmlContent.match(javascript)) {
        response = "There is JavaScript code to be formatted";
        ...
        htmlContent = htmlContent.replace(javascript, function(match, one, two, three) {
            two = two.trim();
            two = two.replace(/^\s+|\s+$|\n+$/g, "");
            // console.log(two);
    ...
    if (htmlContent.match(glsl)) {
        response = "There is GLSL code to be formatted";
        ...
        htmlContent = htmlContent.replace(glsl, function(match, one, two, three) {
            two = two.trim();
            two = two.replace(/^\s+|\s+$|\n+$/g, "");
            // console.log(two);
            var code = hljs.highlight("glsl", two);
