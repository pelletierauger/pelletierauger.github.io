...
exports.fr = {
    ...
    content: `
    <p class="noindent"><em>Récemment, suite à la mise en ligne d'un 
    <a href="https://www.youtube.com/watch?v=FWSR_7kZuYg&t=3s">tutoriel vidéo</a></em> 
    ...
    <div class="section">
    <p class="noindent">U<em>n automate cellulaire</em> est une case dans une grille. 
