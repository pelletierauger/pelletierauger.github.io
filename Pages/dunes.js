exports.fr = {
    ...
    <div id="page">
    <p class="noindent">
    <span class="drop-caps">C</span><span class="small-caps">e projet est basé sur
     <a href="http://koaning.io/fluctuating-repetition.html">Fluctuating Repetition</a></span>,
    ...
    <p class="noindent">Voici le code complet de ce projet, écrit en JavaScript avec la bibliothèque <a href="http://p5js.org/">p5.js</a>.</p>
...
exports.en = {
    ...
    <span class="small-caps">his project is based on 
    <a href="http://koaning.io/fluctuating-repetition.html">Fluctuating Repetition</a></span>, 
    ...
    <p class="noindent">I set the value of \(x_{0}, y_{0}, z_{0}\) to \(0\), but setting them to different values
    ...
    <img src="../../images/dunes/dunes004.jpg">
    <p class="noindent">Here is the complete code for the project, written in JavaScript with the 
